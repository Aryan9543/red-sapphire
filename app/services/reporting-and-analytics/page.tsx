...
import TabsSection from "@/components/ReportTabsSection";
import ReportStackSlider from "@/components/ReportStackSlider";
...
const CareerContent = () => {
  ...
  return (
    <div
      className={`rprt-antc min-h-screen ${
          ...
          <div className='srv-banner-sec-inner flex justify-space-between'>
            ...
            className="right-sd-cont">
                <div className="rsd-cont-box text-end">
                  <Image src="/Images/rgt-rndr-srvc.svg" alt="right-render" className="w-full bnr-rgt"
                      width={567}
                      height={539}
                  />
                </div>
